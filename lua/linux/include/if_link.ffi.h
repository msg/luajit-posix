...
enum MAX_VLAN_LIST_ { MAX_VLAN_LIST_LEN = 1, };

struct ifla_vf_vlan_info {
 uint32_t vf;
 uint32_t vlan;
 uint32_t qos;
 uint16_t vlan_proto; // __be16
};
...
enum IFLA_OFFLOAD_XSTATS_HW_ {
 IFLA_OFFLOAD_XSTATS_HW_S_INFO_UNSPEC,
 IFLA_OFFLOAD_XSTATS_HW_S_INFO_REQUEST,
 IFLA_OFFLOAD_XSTATS_HW_S_INFO_USED,
 __IFLA_OFFLOAD_XSTATS_HW_S_INFO_MAX,
 IFLA_OFFLOAD_XSTATS_HW_S_INFO_MAX = (__IFLA_OFFLOAD_XSTATS_HW_S_INFO_MAX - 1),
};
